...
{
    public class HttpClienteTangoSueldo
    {
        private IConfigurationRoot _configuration;
        public HttpClienteTangoSueldo()
        {
        ...
        {
            var urlTango = _configuration.GetSection("AppSettings").Get<AppSettings>().ApiTangoSueldo;
            // var urlTango = ConfigurationManager.AppSettings["ApiTangoSueldo"];
